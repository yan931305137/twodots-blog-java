...
public class PhotoUtils {
    ...
    private static final File jpegFile = new File("C:\\Users\\yj998\\OneDrive\\桌面\\twodots-blog-java\\src\\main\\resources\\img\\avator.jpg");
    ...
    public static Map<String, Object> photoSave(String imgPath, MultipartFile photo) throws IOException {
        ...
        String newFileName = UUID.randomUUID() + "." + FilenameUtils.getExtension(photo.getOriginalFilename());
